...
" /^joe.*fred.*bill/          : find joe AND fred AND Bill (Joe at start of
" line)
" /^[A-J]/                    : search for lines beginning with one or more
" A-J
...
" /\<\d\{4}\>                 : same thing
" /\([^0-9]\|^\)%.*%          : Search for absence of a digit or beginning of
" line
" " finding empty lines
...
" :vmap <silent> //    y/<C-R>=escape(@", '\\/.*$^~[]')<CR><CR> : with spec
" chars
...
" "home" [N]
" :%s/home.\{-}\zshome/alone  : Substitute only the 2nd occurrence of home in
" any line [U]
...
" " parse xml/soap 
" %s#><\([^/]\)#>\r<\1#g      : split jumbled up XML file into one tag per
" line [N]
" %s/</\r&/g                  : simple split of html/xml/soap  [N]
" :%s#<[^/]#\r&#gic           : simple split of html/xml/soap  but not closing
" tag [N]
...
" :%s#.*\(tbl_\w\+\).*#\1#    : extract list of all strings tbl_* from text
" [NC]
" :s/\(.*\):\(.*\)/\2 : \1/   : reverse fields separated by :
" :%s/^\(.*\)\n\1$/\1/        : delete duplicate lines
" :%s/^\(.*\)\(\n\1\)\+$/\1/  : delete multiple duplicate lines [N]
" " non-greedy matching \{-}
" :%s/^.\{-}pdf/new.pdf/      : delete to 1st occurence of pdf only
" (non-greedy)
" %s#^.\{-}\([0-9]\{3,4\}serial\)#\1#gic : delete up to 123serial or
" 1234serial [N]
...
"  :v/\S/d                     : Delete empty lines (and blank lines ie
"  whitespace)
...
"  :g/stage/t'a                : copy (transfer) lines matching stage to
"  marker a (cannot use .) [C]
...
"  " storing glob results (note must use APPEND) you need to empty reg a first
"  with qaq. 
...
"  v12|                                   : visualise/change/delete to column
"  12 [N]
"  "----------------------------------------
...
"  :set smartcase      : overrides ignorecase if uppercase used in search
"  string (cool)
...
"                        :nmap ,v :e $VIM/_vimrc
"                        :e $MYVIMRC         : edits your _vimrc whereever it
"                        might be  [N]
"                        " How to have a variant in your .vimrc for different
"                        PCs [N]
...
"                        ----------------------------------------
"                        " splitting windows
"                        :vsplit other.php       # vertically split current
"                        file with other.php [N]
"                        ----------------------------------------
...
"                        ----------------------------------------
"                        "vim 7 tabs
"                        vim -p fred.php joe.php             : open files in
"                        tabs
"                        :tabe fred.php                      : open fred.php
"                        in a new tab
"                        :tab ball                           : tab open files
"                        :close                              : close a tab but
"                        leave the buffer *N*
"                        " vim 7 forcing use of tabs from .vimrc
"                        :nnoremap gf <C-W>gf
"                        :cab      e  tabe
"                        :tab sball                           : retab all
"                        files in buffer (repair) [N]
"                        ----------------------------------------
"                        " Exploring
"                        :e .                            : file explorer
"                        :Exp(lore)                      : file explorer note
"                        capital Ex
"                        :Sex(plore)                     : file explorer in
"                        split window
"                        :browse e                       : windows style
"                        browser
"                        :ls                             : list of buffers
"                        :cd ..                          : move to parent
"                        directory
"                        :args                           : list of files
"                        :pwd                            : Print Working
"                        Directory (current directory) [N]
"                        :args *.php                     : open list of files
"                        (you need this!)
"                        :lcd %:p:h                      : change to directory
"                        of current file
"                        :cd  %:p:h                      : change to directory
"                        of current file [N]
"                        :autocmd BufEnter * lcd %:p:h   : change to directory
"                        of current file automatically (put in _vimrc)
"                        ----------------------------------------
"                        " Changing Case
"                        guu                             : lowercase line
"                        gUU                             : uppercase line
...
"                        gf                              : open file name
"                        under cursor (SUPER)
"                        :nnoremap gF :view <cfile><cr>  : open file under
"                        cursor, create if necessary
"                        ga                              : display hex,ascii
"                        value of char under cursor
"                        ggVGg?                          : rot13 whole file
"                        ggg?G                           : rot13 whole file
"                        (quicker for large file)
...
"                                                          : reverse lines top
"                                                          to bottom (toggles)
"                                                          :%s/\(\<.\{-}\>\)/\=join(reverse(split(submatch(1),
"                                                          '.\zs')), '')/g   :
"                                                          reverse all text
"                                                          *N*
"                                                          ----------------------------------------
...
"                                                          ### Cool ###
"                                                          imap ,,,
"                                                          <esc>bdwa<<esc>pa><cr></<esc>pa><esc>kA
"                                                          " list current
"                                                          mappings of all
"                                                          your function keys
"                                                          :for i in range(1,
...
"                                                          ftp://209.51.134.122/public_html/index.html
"                                                          gvim
"                                                          ftp://www.somedomain.com/index.html
"                                                          # uses netrw.vim
"                                                          ----------------------------------------
"                                                          " appending to
"                                                          registers (use
...
"                         :h ctrl<C-D>            : list help of all control
"                         keys
"                         :helpg uganda           : grep HELP Files use :cn,
"                         :cp to find next
...
"                         (matches a <CR>)
"                         :h \\zs                 : double up backslash to
"                         find \zs in help
"                         :h i_CTRL-R             : help for say <C-R> in
"                         insert mode
"                         :h c_CTRL-R             : help for say <C-R> in
"                         command mode
"                         :h v_CTRL-V             : visual mode
"                         :h tutor                : VIM Tutor
"                         <C-]>                   : jump to {keyword} under
"                         cursor in help file [C]
"                         <C-[>, <C-T>            : Move back & Forth in HELP
"                         History
"                         gvim -h                 : VIM Command Line Help
"                         :cabbrev h tab help     : open help in a tab [N]
"                         ----------------------------------------
"                         " where was an option set
"                         :scriptnames            : list all plugins, _vimrcs
"                         loaded (super)
"                         :verbose set history?   : reveals value of history
"                         and where set
"                         :function               : list functions
"                         :func SearchCompl       : List particular function
"                         ----------------------------------------
"                         " making your own VIM help
"                         :helptags /vim/vim64/doc  : rebuild all *.txt help
"                         files in /doc
"                         :help add-local-help
"                         " save this page as a VIM Help File [N]
"                         :sav!
"                         $VIMRUNTIME/doc/vimtips.txt|:1,/^__BEGIN__/d|:/^__END__/,$d|:w!|:helptags
"                         $VIMRUNTIME/doc
"                         ----------------------------------------
...
"                         ----------------------------------------
"                         " capturing output of current script in a separate
"                         buffer
"                         :new | r!perl #                   : opens new
"                         buffer,read other buffer
"                         :new! x.out | r!perl #            : same with named
"                         file
"                         :new+read!ls
"                         ----------------------------------------
"                         " create a new buffer, paste a register "q" into it,
"                         then sort new buffer
"                         :new +put q|%!sort
"                         ----------------------------------------
"                         " Inserting DOS Carriage Returns
"                         :%s/$/\<C-V><C-M>&/g          :  that's what you
"                         type
"                         :%s/$/\<C-Q><C-M>&/g          :  for Win32
"                         :%s/$/\^M&/g                  :  what you'll see
"                         where ^M is ONE character
"                         ----------------------------------------
"                         " automatically delete trailing
"                         Dos-returns,whitespace
"                         autocmd BufRead * silent! %s/[\r \t]\+$//
"                         autocmd BufEnter *.php :%s/[ \t\r]\+$//e
"                         ----------------------------------------
"                         " perform an action on a particular file or file
"                         type
"                         autocmd VimEnter c:/intranet/note011.txt normal!
"                         ggVGg?
"                         autocmd FileType *.pl exec('set fileformats=unix')
"                         ----------------------------------------
"                         " Retrieving last command line command for copy &
"                         pasting into text
"                         i<c-r>:
"                         " Retrieving last Search Command for copy & pasting
"                         into text
"                         i<c-r>/
"                         ----------------------------------------
"                         " more completions
"                         <C-X><C-F>                        :insert name of a
"                         file in current directory
"                         ----------------------------------------
"                         " Substituting a Visual area
"                         " select visual area as usual (:h visual) then type
"                         :s/Emacs/Vim/ etc
"                         :'<,'>s/Emacs/Vim/g               : REMEMBER you
"                         dont type the '<.'>
"                         gv                                : Re-select the
"                         previous visual area (ULTRA)
"                         ----------------------------------------
...
"                         numbers
"                         :map <F12> :set number!<CR>       : Show linenumbers
"                         flip-flop
"                         :%s/^/\=strpart(line('.')."        ",0,&ts)
"                         " numbering lines (need Perl on PC) starting from
"                         arbitrary number
"                         :'a,'b!perl -pne 'BEGIN{$a=223} substr($_,2,0)=$a++'
"                         " Produce a list of numbers
"                         " Type in number on line say 223 in an empty file
"                         qqmnYP`n^Aq                       : in recording q
"                         repeat with @q
"                         " increment existing numbers to end of file (type
"                         <c-a> as 5 characters)
"                         :.,$g/^\d/exe "normal! \<c-a>"
...
"                         return g:I
"                         endfunction
"                         " eg create list starting from 223 incrementing by 5
"                         between markers a,b
"                         :let I=223
"                         :'a,'bs/^/\=INC(5)/
...
"                         unmap =                           : get the original
"                         vim command on a mapped key [N]
"                         ----------------------------------------
"                         " editing/moving within current insert (Really
"                         useful)
"                         <C-U>                             : delete all
"                         entered
"                         <C-W>                             : delete last word
"                         <HOME><END>                       : beginning/end of
"                         line
"                         <C-LEFTARROW><C-RIGHTARROW>       : jump one word
"                         backwards/forwards
"                         <C-X><C-E>,<C-X><C-Y>             : scroll while
"                         staying put in insert
"                         ----------------------------------------
...
"                         :h :X
"                         ----------------------------------------
"                         " modeline (make a file readonly etc) must be in
"                         first/last 5 lines
"                         // vim:noai:ts=2:sw=4:readonly:
"                         " vim:ft=html:                    : says use HTML
"                         Syntax highlighting
"                         :h modeline
"                         ----------------------------------------
...
"                                    enters é (Win32)
"                                    ga                                : View
"                                    hex value of any character
"                                    #Deleting non-ascii characters (some
"                                    invisible)
"                                    :%s/[\x00-\x1f\x80-\xff]/ /g      : type
"                                    this as you see it
"                                    :%s/[<C-V>128-<C-V>255]//gi       : where
"                                    you have to type the Control-V
"                                    :%s/[€-ÿ]//gi                     :
"                                    Should see a black square & a dotted y
"                                    :%s/[<C-V>128-<C-V>255<C-V>01-<C-V>31]//gi
"                                    : All pesky non-asciis
"                                    :exec "norm /[\x00-\x1f\x80-\xff]/"
"                                    : same thing
"                                    #Pull a non-ascii character onto search
"                                    bar
"                                    yl/<C-R>"                         :
"                                    /[^a-zA-Z0-9_[:space:][:punct:]]  :
"                                    search for all non-ascii
"                                    ----------------------------------------
"                                    " All file completions grouped (for
"                                    example main_c.c)
"                                    :e main_<tab>                     : tab
"                                    completes
"                                    gf                                : open
"                                    file under cursor  (normal)
"                                    main_<C-X><C-F>                   :
"                                    include NAME of file in text (insert
"                                    mode)
"                                    ----------------------------------------
"                                    " Complex Vim
"                                    " swap two words
"                                    :%s/\<\(on\|off\)\>/\=strpart("offon", 3
"                                    * ("off" == submatch(0)), 3)/g
"                                    " swap two words
"                                    :vnoremap <C-X> <Esc>`.`gvP``P
"                                    " Swap word with next word
"                                    nmap <silent> gw
"                                    "_yiw:s/\(\%#\w\+\)\(\_W\+\)\(\w\+\)/\3\2\1/<cr><c-o><c-l>
"                                    [N]
"                                    ----------------------------------------
...
"                                    :grep some_keyword *.c            : get
"                                    list of all c-files containing keyword
"                                    :cn                               : go to
"                                    next occurrence
"                                    ----------------------------------------
"                                    " Force Syntax coloring for a file that
"                                    has no extension .pl
"                                    :set syntax=perl
"                                    " Remove syntax coloring (useful for all
"                                    sorts of reasons)
"                                    :set syntax off
"                                    " change coloring scheme (any file in
"                                    ~vim/vim??/colors)
"                                    :colorscheme blue
"                                    :colorscheme morning     : good fallback
"                                    colorscheme *N*
"                                    " Force HTML Syntax highlighting by using
"                                    a modeline
"                                    # vim:ft=html:
"                                    " Force syntax automatically (for a file
"                                    with non-standard extension)
"                                    au BufRead,BufNewFile */Content.IE?/*
"                                    setfiletype html
"                                    " make cursor standout against
"                                    highlighted text for vim terminal (linux)
"                                    [N]
"                                    :highlight search term=reverse ctermbg=5  
"                                    :highlight Normal guibg=white     :
"                                    restore white background [N]
"                                    ----------------------------------------
"                                    :set noma (non modifiable)        :
"                                    Prevents modifications
"                                    :set ro (Read Only)               :
"                                    Protect a file from unintentional writes
"                                    ----------------------------------------
"                                    " Sessions (Open a set of files)
"                                    gvim file1.c file2.c lib/lib.h lib/lib2.h
"                                    : load files for "session"
"                                    :mksession                        : Make
"                                    a Session file (default Session.vim)
"                                    :mksession MySession.vim          : Make
"                                    a Session file named file [C]
"                                    :q
"                                    gvim -S                           :
"                                    Reload all files (loads Session.vim) [C]
"                                    gvim -S MySession.vim             :
"                                    Reload all files from named session [C]
"                                    ----------------------------------------
...
"                                    <C-]>                             : jump
"                                    to function under cursor
"                                    ----------------------------------------
"                                    " columnise a csv file for display only
"                                    as may crop wide columns
"                                    :let width = 20
"                                    :let fill=' ' | while strlen(fill) <
"                                    width | let fill=fill.fill | endwhile
"                                    :%s/\([^;]*\);\=/\=strpart(submatch(1).fill,
"                                    0, width)/ge
"                                    :%s/\s\+$//ge
"                                    " Highlight a particular csv column (put
"                                    in .vimrc)
"                                    function! CSVH(x)
"                                        execute 'match Keyword
"                                        /^\([^,]*,\)\{'.a:x.'}\zs[^,]*/'
"                                            execute 'normal ^'.a:x.'f,'
"                                            endfunction
"                                            command! -nargs=1 Csv :call
"                                            CSVH(<args>)
"                                            " call with
"                                            :Csv 5
"                                            : highlight fifth column
"                                            ----------------------------------------
"                                            zf1G      : fold everything
"                                            before this line [N]
"                                            " folding : hide sections to
...
"                                            zc
"                                            : re-close fold
"                                            " also visualise a section of
"                                            code then type zf [N]
"                                            :help folding
"                                            zfG      : fold everything after
"                                            this line [N]
"                                            ----------------------------------------
...
"                                            :h listchars
"                                            ----------------------------------------
"                                            " How to paste "normal vim
"                                            commands" w/o entering insert
"                                            mode
"                                            :norm qqy$jq
"                                            ----------------------------------------
...
"                                            : help
"                                            :w %
"                                            : write to current file name
"                                            :w %:r.cfm
"                                            : change file extention to .cfm
"                                            :!echo %:p
"                                            : full path & file name
"                                            :!echo %:p:h
"                                            : full path only
...
"                                            "_dw
"                                            : eg delete word (use blackhole)
"                                            ----------------------------------------
"                                            " pull full path name into paste
"                                            buffer for attachment to email
"                                            etc
"                                            nnoremap <F2> :let
"                                            @*=expand("%:p")<cr> :unix
"                                            nnoremap <F2> :let
...
"                                            "\\", "g")<cr> :win32
"                                            ----------------------------------------
"                                            " Simple Shell script to rename
"                                            files w/o leaving vim
"                                            $ vim
"                                            :r! ls *.c
"                                            :%s/\(.*\).c/mv & \1.bla
"                                            :w !sh
"                                            :q!
"                                            ----------------------------------------
"                                            " count words/lines in a text
"                                            file
"                                            g<C-G>
"                                            # counts words
"                                            :echo line("'b")-line("'a")
"                                            # count lines between markers a
"                                            and b [N]
"                                            :'a,'bs/^//n
"                                            # count lines between markers a
"                                            and b
...
"                                            ----------------------------------------
"                                            " reproduce previous line word by
"                                            word
"                                            imap ]
"                                            @@@<ESC>hhkyWjl?@@@<CR>P/@@@<CR>3s
"                                            nmap ]
"                                            i@@@<ESC>hhkyWjl?@@@<CR>P/@@@<CR>3s
"                                            " Programming keys depending on
"                                            file type
"                                            :autocmd bufenter *.tex map <F1>
"                                            :!latex %<CR>
"                                            :autocmd bufenter *.tex map <F2>
"                                            :!xdvi -hush %<.dvi&<CR>
"                                            " allow yanking of php variables
"                                            with their dollar [N]
"                                            :autocmd bufenter *.php :set
"                                            iskeyword+=\$ 
"                                            ----------------------------------------
"                                            " reading Ms-Word documents,
"                                            requires antiword (not docx)
"                                            :autocmd BufReadPre *.doc set ro
"                                            :autocmd BufReadPre *.doc set
"                                            hlsearch!
"                                            :autocmd BufReadPost *.doc
"                                            %!antiword "%"
"                                            ----------------------------------------
"                                            " a folding method
"                                            vim: filetype=help
"                                            foldmethod=marker
"                                            foldmarker=<<<,>>>
"                                            A really big section closed with
"                                            a tag <<< 
